...
public class SVGParser {
	 ...
	 * @throws SVGParseException if there is an error while parsing.
	 */
	public static SVG getSVGFromInputStream(InputStream svgData, HashMap<String, Integer> idToColor)
	 ...
	 * @throws SVGParseException if there is an error while parsing.
	 */
	public static SVG getSVGFromResource(Resources resources, int resId, HashMap<String, Integer> idToColor)
			throws SVGParseException {
	 ...
	 * @throws IOException if there was a problem reading the file.
	 */
	public static SVG getSVGFromAsset(AssetManager assetMngr, String svgPath, HashMap<String, Integer> idToColor)
	...
	private static SVG parse(InputStream in, Integer searchColor, Integer replaceColor, boolean whiteMode,
			HashMap<String, Integer> idToColor) throws SVGParseException {
	...
	private static class Properties {
		...
		public Integer getColor(String name) {
			...
			if (v == null) {
				...
				return v.equalsIgnoreCase("black") ? rgb(0, 0, 0) : v.equalsIgnoreCase("green") ? rgb(0, 128, 0) : v
						.equalsIgnoreCase("silver") ? rgb(192, 192, 192) : v.equalsIgnoreCase("lime") ? rgb(0, 255, 0)
						: v.equalsIgnoreCase("gray") ? rgb(128, 128, 128) : v.equalsIgnoreCase("olive") ? rgb(128, 128,
								0) : v.equalsIgnoreCase("white") ? rgb(255, 255, 255)
								: v.equalsIgnoreCase("yellow") ? rgb(255, 255, 0) : v.equalsIgnoreCase("maroon") ? rgb(
										128, 0, 0) : v.equalsIgnoreCase("navy") ? rgb(0, 0, 128) : v
										.equalsIgnoreCase("red") ? rgb(255, 0, 0) : v.equalsIgnoreCase("blue") ? rgb(0,
										0, 255) : v.equalsIgnoreCase("purple") ? rgb(128, 0, 128) : v
										.equalsIgnoreCase("teal") ? rgb(0, 128, 128)
										: v.equalsIgnoreCase("fuchsia") ? rgb(255, 0, 255)
												: v.equalsIgnoreCase("aqua") ? rgb(0, 255, 255) : null;
			}
		}
